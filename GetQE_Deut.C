...
int main(){
	...
	//TFile *file = new TFile(Form("XS_Deut_QE_%d_Smear.root",(int) (E0) ),"recreate");
	TFile *file = new TFile(Form("XS_Deut_QE_%d_F1F2QE09.root",(int) (E0) ),"recreate");
	...
	const int A=2; 
	const int Z=1; 
	TString Target_Input = "./QE_XEMC/H2_Input.dat";	
